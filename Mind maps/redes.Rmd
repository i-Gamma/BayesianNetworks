...
#### Colores según el tipo de *medio*
```{r colores}
...
#### Títulos de nodo en lugar de figuras

En ocasiones es mejor usar el descriptor o identificador de los nodos como identificación en la gráfica. esto se hace como sigue en R
...
#### Usar imágenes para ilustrar nodos

Otra opciónatractiva es la posibilidad de utilizar imágenes para representar los nodos. Esto puede hacerce con relativa facilidad en R como sigue.
